...
class TestSquidOnlyProxySystem:
    ...
    def test_unblock_proxy_uses_squid(self, mock_get, squid_env):
        ...
        mock_response.text = "<html><body><h1>Test Article</h1>" + "<p>Content here</p>" * 100 + "</body></html>"  # > 1000 chars
    ...
    def test_no_decodo_code_paths_active(self, squid_env):
        ...
        with patch('src.crawler.proxy_config.os.getenv') as mock_getenv:
            ...
            def side_effect(key, default=None):
                ...
                elif key in ["DECODO_USERNAME", "DECODO_PASSWORD", "UNBLOCK_PROXY_USER", "UNBLOCK_PROXY_PASS"]:
    ...
    def test_all_proxy_methods_use_squid(self, mock_get, squid_env):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.text = "<html><body><h1>Title</h1>" + "<p>Content</p>" * 100 + "</body></html>"  # > 1000 chars
        mock_get.return_value = mock_response
    ...
    def test_squid_proxy_challenge_detection(self, mock_get, squid_env):
        ...
        mock_response.text = "Access to this page has been denied by security policy." + " " * 1000
        mock_get.return_value = mock_response
