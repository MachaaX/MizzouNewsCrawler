...
class TestWireServiceDetection:
    ...
    def test_is_high_confidence_boilerplate_privacy_policy(self):
        ...
        assert cleaner._is_high_confidence_boilerplate("Privacy Policy | Terms of Service | Contact Us") is True
    ...
    def test_extract_navigation_prefix_no_nav(self):
        ...
        # Normal article text
        text = "The local school board discussed budget issues at their monthly meeting."
...
class TestHelperMethods:
    ...
    def test_normalize_navigation_token(self):
        ...
        assert BalancedBoundaryContentCleaner._normalize_navigation_token("Contact Us") == "contact"
        assert BalancedBoundaryContentCleaner._normalize_navigation_token("Subscribe!") == "subscribe"
