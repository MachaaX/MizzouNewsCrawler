...
class TestContentCleanerBasics:
    ...
    def test_get_articles_for_domain_uses_provided_session(self):
        ...
        with patch(
            "src.utils.content_cleaner_balanced.safe_session_execute",
            return_value=mock_result,
        ) as mock_execute:
            articles = cleaner._get_articles_for_domain(
                "example.com", sample_size=10, session=mock_session
            )
    ...
    def test_get_persistent_patterns_uses_provided_session(self):
        ...
        with patch(
            ...
            patterns = cleaner._get_persistent_patterns_for_domain(
                "example.com", session=mock_session
            )
    ...
    def test_no_nested_sessions_created_when_session_provided(self):
        ...
        with patch(
            ...
            for call_args in mock_execute.call_args_list:
                ...
                assert (
                    call_args[0][0] != mock_session
                ), "Should not use db.session when session is provided"
    ...
    def test_session_reuse_prevents_nested_context_managers(self):
        ...
        with patch(
            ...
            cleaner._get_persistent_patterns_for_domain(
                "example.com", session=provided_session
            )
...
class TestExtractionCommandIntegration:
    ...
    def test_extraction_command_passes_session_to_cleaner(self):
        ...
        with patch(
            ...
            assert all(
                call_args[0][0] == session for call_args in mock_execute.call_args_list
...
class TestContentCleanerCore:
    ...
    def test_normalize_navigation_token(self):
        ...
        assert (
            BalancedBoundaryContentCleaner._normalize_navigation_token("News") == "news"
        )
        assert (
            BalancedBoundaryContentCleaner._normalize_navigation_token("  SPORTS  ")
            == "sports"
        )
    ...
    def test_generate_removal_reason(self):
        ...
        reason = cleaner._generate_removal_reason(
            "Copyright © 2023 Example Corp", "footer", 0.95, 10
        )
    ...
    def test_calculate_position_consistency(self):
        ...
        consistency = cleaner._calculate_position_consistency(
    ...
    def test_filter_with_balanced_boundaries(self):
        ...
        filtered = cleaner._filter_with_balanced_boundaries(
            articles, candidates, min_occurrences=2, telemetry_id="test"
        )
